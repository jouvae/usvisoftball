---
description: Frontend BDD plan QA specialist. Reviews frontend portions of a plan before implementation. Validates scenarios, TypeScript contracts, API route stubs, and test specs are consistent with nextjs-tester/nextjs-implementer conventions. Returns structured review report — does not modify any file.
mode: subagent
permission:
  read: allow
  glob: allow
