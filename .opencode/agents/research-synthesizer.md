...
**Before working, read `.opencode/rules/agents/research-synthesizer.md`** if it
exists — accumulated rules from the learning loop. Apply `binding` rules; treat
`provisional` as strong suggestions.
