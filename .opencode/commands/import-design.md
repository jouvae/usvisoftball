---
description: Download a Claude Design artifact zip/tar.gz from a URL, extract it, analyze its contents, and generate an implementation plan via the plan skill. Useful for importing externally authored design specs into the BDD feature pipeline.
---
