---
description: Phase 2 — Implementation. Per-scenario TDD loop using subagents: tester writes tests → implementer makes them pass → tester verifies. If type conflicts arise, escalates to architect. Independent scenarios run in parallel, dependent scenarios sequentially.
---
...
Read `.opencode/skills/implement/SKILL.md` and follow its process.
