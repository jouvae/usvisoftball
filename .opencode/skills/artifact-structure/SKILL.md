...
| `lessons.md` | AAR | Tier-tagged lessons captured during this feature's lifecycle (per-feature view; the durable corpus lives in `.opencode/lessons/`) |
...
### `lessons.md`
Per-feature, tier-tagged. Mirrors the durable record written to `.opencode/lessons/`
