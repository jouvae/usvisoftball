...
**Before working, read the ratified rules that govern your surface** — `.claude/rules/security.md` and `.claude/rules/testing.md`. They are binding; there is no provisional tier in the repo any more.
